...
function ST.SummonBankNPC(player)
    ST.SummonNPC(player, 290011)
end

function ST.SummonProNPC(player)
    ST.SummonNPC(player, 190093)
end
...
local Stone={
	...
	CastSpell=function(player, spellid)
		player:CastSpell(player, spellid, true)
		if spellid == 22888 then
...
local Menu={
    [MMENU]={--主菜单
		...
		{FUNC, "召唤商人银行",     ST.SummonBankNPC,    GOSSIP_ICON_MONEY_BAG},
		{FUNC, "召唤商业商人",     ST.SummonProNPC,    GOSSIP_ICON_MONEY_BAG},
        --{FUNC, "附魔大师NPC",    ST.SummonENPC,    GOSSIP_ICON_TABARD},
        {MENU, "职业技能训练师",   MMENU+0x20,        GOSSIP_ICON_BATTLE},
        {MENU, "骑术武器训练师",   MMENU+0x30,        GOSSIP_ICON_BATTLE},
        -- {FUNC, "强制脱离战斗",     Stone.OutCombat,GOSSIP_ICON_CHAT},
		{MENU, "马戏团光环",   BUFFMENU,   GOSSIP_ICON_BATTLE},
        {FUNC, "副本宠物加光环",   ST.AddAuraToPet,   GOSSIP_ICON_BATTLE},
    },
	[BUFFMENU]={
		{BUF, "Armor + 10%",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 23767},
		{BUF, "Damage + 1 - 10%",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 23768},
		{BUF, "Resistances + 25",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 23769},
		{BUF, "Agility + 10%",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 23736},
		{BUF, "Intelligence + 10%",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 23766},
		{BUF, "Spirit + 10%",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 23738},
		{BUF, "Strength + 10%",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 23735},
		{BUF, "Stamina + 10%",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 23737},
		{BUF, "Heal Me",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 25840},
		{BUF, "ony",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 22888},
		{BUF, "rend",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 16609},
		{BUF, "fengus",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 22817},
		{BUF, "moldar",         Stone.CastSpell,        GOSSIP_ICON_BATTLE, 22818},
    ...
    [TPMENU+0x120]={--东部王国    2
		...
		{TP, "阿拉希落锤", 0,  -947, -3528, 71.4168, 0.490373},
        {TP, "荆棘谷",  0,  -11921.7, -59.544, 39.7262, 3.7357},
		{TP, "荆棘谷小岛",  0,  -11827, 1241, 1.6, 3.7357},
		...
		{TP, "燃烧平原基地",  0,  -8375, -2757.72, 187.919, 5.10148},
        {TP, "西瘟疫之地", 0,    1743.69, -1723.86, 59.6648, 5.23722},
		{TP, "西瘟疫之地部落", 0,  1721.95, -726.918, 58.1137, 4.2436},
        {TP, "东瘟疫之地", 0,  2280.64, -5275.05, 82.0166, 4.747},
		{TP, "naxx传送", 0,  3069, -3875, 130, 3.1},
    ...
    [TPMENU+0x40]={--卡利姆多
		...
		{TP, "尘泥沼泽塔贝萨", 1, -4037.12, -3382.85, 38.0364, 5.12666},
        ...
        {TP, "费伍德森林南", 1, 3898.8, -1283.33, 220.519, 6.24307},
		{TP, "费伍德森林中", 1, 5283.8, -717.33, 346.519, 6.24307},
		{TP, "费伍德森林北", 1, 6808.8, -2079.33, 624.519, 6.24307},
		...
		{TP, "月光林地", 1, 7844.57, -2214.48, 471.019, 5.18088},
    },
    [TPMENU+0x50]={--外域
    ...
    [ENCMENU]={-- Enchanter 附魔
		...
		{MENU, "戒指1",      ENCMENU+0x100,GOSSIP_ICON_TABARD},
		{MENU, "戒指2",      ENCMENU+0x110,GOSSIP_ICON_TABARD},
    },
    [ENCMENU+0x10] = { -- 衬衣
    ...
    [ENCMENU+0x20] = { -- 头部
		...
		{ENC, "思维放大罗盘", 3878, EQUIPMENT_SLOT_HEAD},
    },
    [ENCMENU+0x30] = { -- 肩部
		...
		{ENC, "大师的利斧铭文", 3835, EQUIPMENT_SLOT_SHOULDERS},
		{ENC, "大师的峭壁铭文", 3836, EQUIPMENT_SLOT_SHOULDERS},
		{ENC, "大师的巅峰铭文", 3837, EQUIPMENT_SLOT_SHOULDERS},
		{ENC, "大师的风暴铭文", 3838, EQUIPMENT_SLOT_SHOULDERS},
    ...
    [ENCMENU+0xf0] = { -- 腰部
		...
		{ENC, "永恒腰带扣", 3729, EQUIPMENT_SLOT_WAIST},
		{ENC, "弹带", 3601, EQUIPMENT_SLOT_WAIST},
    ...
    [ENCMENU+0x50] = { -- 腿部
		...
		{ENC, "冰虫腿甲强化片", 3327, EQUIPMENT_SLOT_LEGS},
		{ENC, "蛛魔腿甲强化片", 3328, EQUIPMENT_SLOT_LEGS},
		{ENC, "大师的魔线", 3873, EQUIPMENT_SLOT_LEGS},
		{ENC, "神圣魔线", 3872, EQUIPMENT_SLOT_LEGS},
    ...
    [ENCMENU+0x60] = { -- 脚部
		...
		{ENC, "硝化甘油推进器", 3606, EQUIPMENT_SLOT_FEET},
    ...
    [ENCMENU+0x70] = { -- 护腕
		...
		{ENC, "毛皮衬垫 – 耐力", 3757, EQUIPMENT_SLOT_WRISTS},
		{ENC, "毛皮衬垫 – 法术强度", 3758, EQUIPMENT_SLOT_WRISTS},
		{ENC, "毛皮衬垫 – 攻击强度", 3756, EQUIPMENT_SLOT_WRISTS},
		{ENC, "毛皮衬垫 – 暗影抗性", 3761, EQUIPMENT_SLOT_WRISTS},
		{ENC, "毛皮衬垫 – 奥术抗性", 3763, EQUIPMENT_SLOT_WRISTS},
		{ENC, "毛皮衬垫 – 冰霜抗性", 3760, EQUIPMENT_SLOT_WRISTS},
		{ENC, "毛皮衬垫 – 火焰抗性", 3759, EQUIPMENT_SLOT_WRISTS},
		{ENC, "毛皮衬垫 – 自然抗性", 3762, EQUIPMENT_SLOT_WRISTS},
		
		{ENC, "插槽护腕", 3717, EQUIPMENT_SLOT_WRISTS},
    ...
    [ENCMENU+0x80] = { -- 手套
		...
		{ENC, "超级加速器", 3604, EQUIPMENT_SLOT_HANDS},
		{ENC, "插槽手套", 3723, EQUIPMENT_SLOT_HANDS},
    ...
    [ENCMENU+0x90] = { -- 背部
		...
		{ENC, "弹力蛛丝", 3859, EQUIPMENT_SLOT_BACK},
		{ENC, "高弹力衬垫", 3605, EQUIPMENT_SLOT_BACK},
		{ENC, "亮纹刺绣", 3722, EQUIPMENT_SLOT_BACK},
		{ENC, "剑刃刺绣", 3720, EQUIPMENT_SLOT_BACK},
		{ENC, "黑光刺绣", 3728, EQUIPMENT_SLOT_BACK},
    ...
    [ENCMENU+0x100]={-- 戒指1
        {ENC, "清除戒指附魔",-1,EQUIPMENT_SLOT_FINGER1},
        {ENC, "强效法术能量", 3840, EQUIPMENT_SLOT_FINGER1},
        {ENC, "突袭", 3839, EQUIPMENT_SLOT_FINGER1},
        {ENC, "耐力", 3791, EQUIPMENT_SLOT_FINGER1},
    },    
	[ENCMENU+0x110]={-- 戒指2
        {ENC, "清除戒指附魔",-1,EQUIPMENT_SLOT_FINGER2},
        {ENC, "强效法术能量", 3840, EQUIPMENT_SLOT_FINGER2},
        {ENC, "突袭", 3839, EQUIPMENT_SLOT_FINGER2},
        {ENC, "耐力", 3791, EQUIPMENT_SLOT_FINGER2},
    },
}
...
local function Enchanting(player, EncSpell, Eid, money) --附魔 (玩家,附魔效果,附魔位置)
    ...
    if (Nowitem and Eid )  then--存在物品
		...
		if EncSpell == 3729 or EncSpell == 3717 or EncSpell == 3723 then
			local espellid=Nowitem:GetEnchantmentId(6)
			if(espellid and espellid>0)then
				player:SendBroadcastMessage(WName.."已经存在("..espellid..")")
			else
				Nowitem:SetEnchantment(EncSpell, 6)
			end
			return true
		end
