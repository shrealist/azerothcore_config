...
-- 导出  表 acore_world.creature_template_npcbot_appearance 结构
...
-- 正在导出表  acore_world.creature_template_npcbot_appearance 的数据：~283 rows (大约)
