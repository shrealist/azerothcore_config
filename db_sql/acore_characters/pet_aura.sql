...
-- 正在导出表  acore_characters.pet_aura 的数据：~17 rows (大约)
...
INSERT INTO `pet_aura` (`guid`, `casterGuid`, `spell`, `effectMask`, `recalculateMask`, `stackCount`, `amount0`, `amount1`, `amount2`, `base_amount0`, `base_amount1`, `base_amount2`, `maxDuration`, `remainTime`, `remainCharges`) VALUES
	...
	(4, 0, 57723, 1, 1, 1, 0, 0, 0, 0, 0, 0, 600000, 136889, 0),
	(4, 13, 57623, 3, 3, 1, 155, 155, 0, 154, 154, 0, 180000, 147433, 0),
	(4, 17379392136981512224, 47440, 1, 0, 1, 2818, 0, 0, 2254, 0, 0, 600000, 386301, 0),
	(4, 17379392137518383155, 20217, 3, 3, 1, 10, 0, 0, 9, -1, 0, 3600000, 2192431, 0),
	(4, 17379392140152406049, 48073, 1, 1, 1, 80, 0, 0, 79, 0, 0, 3600000, 2220800, 0),
	(4, 17379392140152406049, 48161, 1, 1, 1, 165, 0, 0, 164, 0, 0, 3600000, 2195507, 0),
	(4, 17379392140152406049, 48169, 1, 1, 1, 130, 0, 0, 129, 0, 0, 3600000, 2214790, 0),
	(4, 17379392141947568178, 42995, 1, 1, 1, 60, 0, 0, 59, 0, 0, 3600000, 2168021, 0),
	(4, 17379392143424096472, 48469, 7, 0, 1, 1050, 51, 75, 749, 36, 53, 3600000, 2214630, 0),
	(7, 17379392137015066661, 47436, 3, 2, 1, 687, 550, 0, 547, 547, 0, 600000, 343004, 0),
	(7, 17379392137635823654, 20217, 3, 3, 1, 10, 0, 0, 9, -1, 0, 3600000, 1421158, 0),
	(7, 17379392141930790952, 42995, 1, 1, 1, 60, 0, 0, 59, 0, 0, 3600000, 1426674, 0),
	(7, 17379392143407185959, 48469, 7, 0, 1, 1050, 51, 75, 749, 36, 53, 3600000, 1419985, 0);
