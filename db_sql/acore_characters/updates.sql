...
-- 导出  表 acore_characters.updates 结构
...
-- 正在导出表  acore_characters.updates 的数据：~6 rows (大约)
DELETE FROM `updates`;
INSERT INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES
	...
	('2023_05_16_00_characters_npcbot_gear_storage.sql', '420BD98105455A0DC0E27DE6489EC9D8E4F811CD', 'CUSTOM', '2024-03-02 16:54:03', 99),
	('2023_05_23_00.sql', 'A1A442D3F5049CDA2C067761F768C08BEFFFD26A', 'RELEASED', '2024-01-20 13:25:01', 35),
	('2023_05_26_00_characters_npcbot_transmog.sql', '3304DE86E5F61AB6A20A48E2192904F0C664359F', 'CUSTOM', '2024-03-02 16:54:03', 139),
