...
-- 正在导出表  acore_characters.mail 的数据：~3 rows (大约)
DELETE FROM `mail`;
INSERT INTO `mail` (`id`, `messageType`, `stationery`, `mailTemplateId`, `sender`, `receiver`, `subject`, `body`, `has_items`, `expire_time`, `deliver_time`, `money`, `cod`, `checked`) VALUES
	(1, 3, 41, 0, 16128, 17, '80级！', '恭喜你在探险的过程中到达了80级，毫无疑问，你把自己所有精力都献身于同企图征服艾泽拉斯的恶魔做斗争的事业中去了，并且应该做到了不小的成就。$B$B你虽已到达80级，但还不是值得庆贺的时候，更大的挑战还在等待着你。$B$B继续战斗吧！$B$B罗宁', 1, 1761513028, 1758921028, 0, 0, 0),
	(4, 3, 41, 264, 32838, 17, '', '', 1, 1761890032, 1759298032, 0, 0, 0),
	(5, 3, 41, 0, 37941, 17, '夺日者圣殿的纹章收集者', '朋友，你在诺森德所取得的成就让人不得不注意。$B$B用获取的纹章在达拉然换取对应的装备，武装自己来更强大，不是每个人都乐意的么？$B$B在达拉然的夺日者圣殿，你能找到每一种纹章所对应的兑换师，在他的身上，你能收获许多。$B$B期待你的到来！', 0, 1761904139, 1759312139, 0, 0, 0);
